  ...
  <b-container class="team-page">
    ...
    <section class="alumni-section" id="alumni">
      <div class="alumni-header">
        ...
        <div class="alumni-dashboard-cta">
          <router-link to="/training" class="dashboard-cta-link">
            <span class="cta-icon">🎓</span>
            <div class="cta-text">
              <span class="cta-headline">One Year Training in the Lab: 101</span>
              <span class="cta-sub">Explore technical mastery, presentation skills, career guidance &amp; alumni testimonials →</span>
            </div>
          </router-link>
        </div>
      </div>
