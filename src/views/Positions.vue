  ...
  <div>
    <b-container>
      ...
      <b-row>
        ...
        <p>
          Project-based trainees can either join for a period of six months or 1
          year. During your initial few weeks, we will mutually assess fit for
          different projects in the lab and assign the trainee to a suitable
          project based on their interest. Feel free to reach out to our current
          Project trainees listed under the Team page to find out about their
          experience.
        </p>
        <p>
      ...
      <b-row>
        ...
        <p>
          We are always looking for motivated post-doctoral fellows to join our
          crew. If you are interested in our work, please write to Ishwariya to
          discuss the possibility of writing post-doctoral fellowships together
          to fund your research and time in the lab.
        </p>
      </b-row>
      <b-row>
